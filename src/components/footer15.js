...
const Footer15 = (props) => {
          ...
          <div className="footer15-actions">
            ...
            <div className="footer15-media">
              <div className="footer15-container2">
                <img
                  alt={props.logoAlt}
                  src='../logo.9cdc0b28d3eff358cfb1-200h.png'
  ...
  © 2024 Bagni Torino NICA<br />
  P.IVA 11924880013<br />
  Designed by allexandrum
</span>
        </div>
      </div>
    </div>
...
Footer15.defaultProps = {
  ...
  content1: 'Subscribe to our newsletter for exclusive offers',
  content2: 'Follow us on social media for more updates',
  copyright: '© 2024 Bagni Torino NICA\n' +
      'P.IVA 11924880013\n' +
      'Designed by allexandrum.',
}
